...
import ActitivityDetails from "../details/ActivityDetails";
...
export default function ActivityDashboead({activities, selectedActivity, selectActivity, cancelSelectActivity,
